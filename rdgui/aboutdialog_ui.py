...
class Ui_AbooutDialog(object):
    ...
    def retranslateUi(self, AbooutDialog):
        ...
        self.labelDescription.setText(_translate("AbooutDialog", "<html><head/><body><p align=\"center\">A visualizer for sorage ring\'s DCCT current.</p><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\">Copyright (c) Shahab Sanjari 2016-2024.</p><p align=\"center\">License: GPLv3</p><p align=\"center\"><br/></p></body></html>"))
